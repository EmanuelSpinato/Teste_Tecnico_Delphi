...
begin
  ...
  edSenha.Text := qrDados.FieldByName('SENHA').AsString;  // Sem decodificação
end;
...
begin
  ...
  qrDados.FieldByName('SENHA').AsString := edSenha.Text;  // Sem criptografia
end;

procedure TfmCadastroUsuarios.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
